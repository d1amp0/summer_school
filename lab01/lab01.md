...
5. Когда HTML-файл, который вы извлекаете, последний раз модифицировался на сервере?
   - Вторник, 18 июня 2024, 8:59:02 по мск
6. Сколько байтов контента возвращается вашему браузеру?
   - 128 байтов

![image](https://github.com/d1amp0/summer_school/assets/118923542/eccc449a-5cc5-4a49-99e5-7caf45e3d250)
...
3. Теперь проверьте содержимое второго HTTP-запроса GET (из вашего браузера на сторону
   ...
   - Да, стоит дата: вторник, 18 июня 2024, 8:59:02 по мск
4. Какой код состояния HTTP и фраза возвращаются сервером в ответ на этот второй запрос
   ...
   - 304 Not Modified
   - Нет, потому что код состояния 304

![image](https://github.com/d1amp0/summer_school/assets/118923542/20de9148-7f41-40d1-9100-ba2231f5332a)
...
4. Есть ли в передаваемых данных какая-либо информация заголовка HTTP, связанная с
   сегментацией TCP?
   - Да
  ![image](https://github.com/d1amp0/summer_school/assets/118923542/b86e8fa4-73fe-49b4-b4d1-e9f7ecc79639)
...
2. Можете ли вы сказать, загрузил ли ваш браузер два изображения последовательно или
   ...
   - Они загрузились последователно
  
![image](https://github.com/d1amp0/summer_school/assets/118923542/ed2006da-b162-4942-b23d-6788bc935835)
...
2. Когда ваш браузер отправляет сообщение HTTP GET во второй раз, какое новое поле включается в сообщение HTTP GET?
   - Authorization
  ![image](https://github.com/d1amp0/summer_school/assets/118923542/ce136b91-f3c8-4ea6-8dca-ea5f69badec6)
